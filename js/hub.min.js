...
b=this.getOrder("default",b);this.load("?module=topics"+(b?"&sort="+b:""),function(){})},getOrder:function(b,c){b="hub/"+b+"/order";return c?(a.storage.set(b,c),c):a.storage.get(b)},initLazyLoad:function(){var b=a(".lazyloading-paging");if(b.length){var c=parseInt(b.data("times"),10),d=b.data("linkText")||"Load more",e=b.find("li.selected");if("1"==e.children("a").text()){b.hide();var f=a(window);f.lazyLoad("stop");e.next().length&&f.lazyLoad({container:"#h-content .h-topics",load:function(){f.lazyLoad("sleep");
var b=a(".lazyloading-paging").hide(),e=a(".h-footer"),j=b.find("li.selected").next().find("a").attr("href");if(j){var i=a("#h-content .h-topics");a.get(j,function(j){j=a("<div></div>").html(j);i.append(j.find("#h-content .h-topics").children());var n=j.find(".lazyloading-paging").hide();b.replaceWith(n);b=n;e.replaceWith(j.find(".h-footer"));c-=1;b.find("li.selected").next().length?!isNaN(c)&&0>=c?(f.lazyLoad("sleep"),a(".lazyloading-load-more").length||a('<a href="#" class="lazyloading-load-more">'+
d+"</a>").insertAfter(b).click(function(){c=1;f.lazyLoad("wake");f.lazyLoad("force");return!1})):f.lazyLoad("wake"):f.lazyLoad("stop");j.remove()})}else f.lazyLoad("stop")}})}}},popularAction:function(){this.defaultAction("popular")},archiveAction:function(){this.defaultAction("archive")},updatedAction:function(){this.defaultAction("updated")},recentAction:function(){this.defaultAction("recent")},unansweredAction:function(){this.defaultAction("unanswered")},contactAction:function(b,c,d){(d=d||"")&&
(d="&sort="+d);(c=c||"")&&(c="&hub_id="+c);this.load("?module=topics"+d+c+"&hash=contact/"+encodeURIComponent(b),function(){a(".h-header .h-sort").remove()})},load:function(b,c){var d=this.options,e=a.hub.load_protector=Math.random();a.get(b,{},function(b){if(e===a.hub.load_protector){a("#content").html(b);b=a("#content").find("h1:first");b.length&&(b=b.children().length?b.find(".title").length?b.find(".title").text():b.contents()[0].textContent?b.contents()[0].textContent:b.contents()[0].innerText:
b.text(),document.title=b+" \u2014 "+d.accountName);if(c)try{c.call(this)}catch(g){}a(window).trigger(a.Event("wa_loaded"))}})},typeAction:function(a,c){this.load("?module=topics&hash=type/"+a+(c?"&sort="+c:""),function(){})},hubAction:function(a,c){c=this.getOrder("hub"+a,c);this.load("?module=topics&hash=hub/"+a+(c?"&sort="+c:""))},followingAction:function(a){a=this.getOrder("following",a);this.load("?module=topics&hash=following"+(a?"&sort="+a:""),function(){})},categoryAddAction:function(a){var c=
...
waDesignLoad():a("#content").load("?module=design",function(){waDesignLoad(b)}):a("#content").load("?module=design",function(){waDesignLoad("")})},designThemesAction:function(){a("#wa-design-container").length?waDesignLoad():a("#content").load("?module=design",function(){waDesignLoad()})},streamSettingsSaveHandler:function(b,c,d,e,f,g){d.find(":submit").attr("disabled",null);if("ok"==b.status){if(c.slideUp(),g&&(g.find(".icon16").removeClass("loading").addClass("category"==f?"settings":"funnel"),
g.show()),b.data){b=b.data||{};switch(f){case "category":a.hub.helper.updateCategory(e||b.id,b);break;case "filter":a.hub.helper.updateFilter(e||b.id,b)}if(e)switch(a(".h-saved").slideDown(),c=function(){a(".h-saved").show();setTimeout(function(){a(".h-saved").slideUp()},4E3)},f){case "category":0<b.type&&a.hub.categoryAction(e,null,c);break;case "filter":a.hub.filterAction(e,null,c)}else window.location.hash="/"+f+"/"+b.id+"/"}}else a.hub.helper.formError(d,b.errors||{},"category")},streamDeleteHandler:function(b,
...
"filter"==d?"icon":"glyph");g.find(':input[name$="\\[name\\]"]:first').focus();g.submit(function(){a.hub.helper.formError(g);g.find(":submit").attr("disabled",!0);a(".tagsinput input").trigger(jQuery.Event("keypress",{which:13}));var h=new FormData(this),j=g.find("#h-category-logo-progressbar"),i=setTimeout(function(){g.find(".progressbar").show()},2E3);a.ajax({url:g.attr("action"),type:"POST",async:!0,xhr:function(){var b=a.ajaxSettings.xhr();b.upload&&g.find(':input[type="file"]').length&&b.upload.addEventListener("progress",
function(a){if(a.lengthComputable){var b=a.loaded||a.position,a=a.totalSize||a.total;j.show();j.css("width",Math.min(100,Math.floor(100*(b/a)))+"%")}},!1);return b},success:function(h){try{clearTimeout(i);g.find(".progressbar").hide();var j=a.parseJSON(h);f.streamSettingsSaveHandler(j,e,g,b,d,c||!1)}catch(o){a.hub.helper.formError(g,{submit:h.replace(/<\/?[^>]+>/gi,"").substr(0,512)},"category")}},data:h,cache:!1,contentType:!1,processData:!1});return!1});a("a.cancel",e).click(function(){e.slideUp();
c?(c.find(".icon16").removeClass("loading").addClass("category"==d?"settings":"funnel"),c.show()):window.location.hash="/";return!1});b&&a("a.js-delete",e).click(function(){var c=a(this);if("category"==d&&c.hasClass("js-dialog")){var e=a("#h-category-delete");e.waDialog({onSubmit:function(){f.streamDeleteHandler(b,d,e.find("form").serialize());return!1}})}else confirm($_("Are you sure?"))&&f.streamDeleteHandler(b,d);return!1})},manageHandler:function(){a("#blog-stream-primary-menu").hide();a("#blog-stream-manage-menu").show();
this.management=!0;this.onContentUpdate();return!1},manageCompleteHandler:function(){this.management=!1;a("#blog-stream-manage-menu").hide();a("#blog-stream-primary-menu").show();a(".b-post.js-managed").each(function(){a(this).removeClass("js-managed");a(this).find("h3:hidden").show();a(this).find("h3:first").hide();a(this).find(".b-post-body:hidden, .profile.image20px:hidden").fadeIn()});return!1},topics:{$topics_ul:null,$bulk_menu:null,$sort_menu:null,init:function(b){if(b&&"undefined"!=typeof b.topics_count){var c=
a("#wa-app > .sidebar li.selected:first .count:first");c.length&&c.text(b.topics_count)}this.$topics_ul=a("ul.h-topics");this.initBulkActions();this.initFollowLinks();this.$topics_ul.on("click",".toggle-comments",function(){a(this).closest("li").find(".h-comments").slideToggle()});a(".h-saved .h-close-saved").on("click",function(){a(this).closest(".h-saved").slideUp();return!1})},initBulkActions:function(){function b(b,c,d){if(b&&c&&b[0]&&c[0]&&!b.is(c[0])){var e=!1;c.parent().children().each(function(i,
k){if(e){if(b.is(k)||c.is(k))return!1;a(k).find("input:checkbox.js-bulk-mode").prop("checked",d)}else if(b.is(k)||c.is(k))e=!0})}}var c=this;this.$bulk_menu=a("ul.js-bulk-menu:first");this.$sort_menu=a("ul.js-sort-menu:first");this.$bulk_menu.find("a:first").click(function(){a(this).is(":visible")&&c.$topics_ul.addClass("h-bulk-mode");c.$sort_menu.hide();c.$bulk_menu.find("li").toggle();c.bulkCount();return!1});this.$bulk_menu.find("a:last").click(function(){a(this).is(":visible")&&c.$topics_ul.removeClass("h-bulk-mode");
c.$sort_menu.show();c.$bulk_menu.find("li").toggle();return!1});this.$bulk_menu.find("a.js-bulk-action").click(function(){var b=a(this);if(c.bulkCount()){var d=b.data("confirm");if(!d||confirm(d))d=b.data("action"),d="bulk"+d.substr(0,1).toUpperCase()+d.substr(1),c[d+"Action"].apply(c,[b])}else alert($_("Select at least one topic"));return!1});this.$topics_ul.on("change",":input.js-bulk-mode",function(){c.bulkCount()});var d=null,e=null;this.$topics_ul.on("click",":input.js-bulk-mode",function(f){var g=
a(this),h=g.closest(".h-topic");g.prop("checked")?(f.shiftKey&&d&&b(d,h,!0),d=h,e=null):(f.shiftKey&&e&&b(e,h,!1),d=null,e=h);c.bulkCount()})},initFollowLinks:function(){this.$topics_ul.on("click",".h-follow",function(){var b=a(this),c=b.find("i"),d=c.hasClass("star-empty")?1:0;a.post("?module=following",{topic_id:b.data("topic"),follow:d},function(e){if("ok"==e.status){var e=parseInt(a("#following-count").html()),f=b.closest("li"),g=f.find(".h-comments");d?(g.slideDown(),f.addClass("h-followed").removeClass("h-not-followed"),
b.addClass("highlighted"),c.removeClass("star-empty").addClass("star"),b.find(".followers-count").html($_("Following")),e+=1):(g.slideUp(),f.removeClass("h-followed").addClass("h-not-followed"),b.removeClass("highlighted"),c.addClass("star-empty").removeClass("star"),b.find(".followers-count").html(""),e-=1);a("#following-count").addClass("highlighted").html(e)}},"json");return!1})},initManualDragAndDrop:function(b){this.$topics_ul.sortable({items:"> li",distance:5,tolerance:"pointer",handle:".sort,h3 a,i.h-glyph32",
...
var d=this;a.ajax({url:"?module=topics&action=delete",dataType:"json",type:"post",data:{ids:c},success:function(a){b.find("i.icon16").removeClass("loading").addClass("delete");d.$bulk_menu.find("a:last").click();if("ok"!=a.status)default_error_handler(a);else if(a.data.deleted)for(var c in a.data.deleted)a.data.deleted.hasOwnProperty(c)&&d.$topics_ul.find('>li[data-id="'+a.data.deleted[c]+'"]').remove()}})},bulkMoveAction:function(b){var b="&hub_id="+b.data("hub")+"&category_id="+b.data("category"),
c=a("#h-bulk-topics-move"),d=this;c.hasClass("dialog")?d.bulkMoveDialog(c):c.load("?module=dialog&action=topicsMove"+b,function(){c.addClass("dialog");c.find(':input[name="hub_id"]').change(function(){if(this.checked){c.find("select").attr("disabled",!0);var b=a(this).parents(".value:first").find("select:first");b.length&&b.attr("disabled",null)}}).change();d.bulkMoveDialog(c)})},bulkMoveDialog:function(b){var c=this;b.waDialog({disableButtonsOnSubmit:!0,onLoad:function(){var a=[];c.$topics_ul.find(":input.js-bulk-mode:checked").each(function(){a.push(this.value)});
b.find(':input[name="topic_ids"]').val(a.join(","))},onSubmit:function(){var c=b.find("form:first"),e=c.find(':input[name="hub_id"]:checked'),f=e.val(),g=e.parents(".value:first").find("select:first").val();a.ajax({url:c.attr("action"),data:c.serialize(),dataType:"json",type:"post",success:function(){b.waDialog("close");window.location.hash=g?"/category/"+g+"/":f?"/hub/"+f+"/":"/"}});return!1}})}},helper:{formError:function(b,c,d){b.find(":submit").attr("disabled",null);if(c){for(var e in c||{})if(c.hasOwnProperty(e)){var f=
b.find(this.getSelector(e,d));f.length||(f=b.find(this.getSelector(e)));f.length||(f=b.find(":submit:first"));f.addClass("error");var g=f.next(".errormsg");g.length?g.text(c[e]):f.after(a('<em class="errormsg"></em>').text(c[e]))}b.find("input.error:first").focus()}else b.find(":input.error").removeClass("error"),b.find(".errormsg").text("")},updateCategory:function(b,c){var d=a.sidebar.sidebar.find("#category-"+b);d.length?(d.find(".count").text(c.topics_count),d.find(".name").text(c.name),d.find(".js-glyph").replaceWith(c.glyph_html),
a("h1.list-title .title").text(c.name)):(d=a('<li class="drag-newposition"></li><li class="dr" id="category-'+c.id+'"><span class="count">'+c.topics_count+'</span><a href="#/category/'+c.id+'/">'+c.glyph_html+'<span class="name">name placeholder</span><span class="count"><i class="icon10 add h-new-category" data-category-id="'+c.id+'"></i></span></a></li>'),a('div.h-hub[data-hub-id="'+c.hub_id+'"] .category-list > ul:first').prepend(d),d.find(".name").text(c.name))},updateFilter:function(b,c){var d=
a.sidebar.sidebar.find('a[href="\\#/filter/'+b+'/"]').parents("li");d.length?(d.find(".count").text(c.topics_count),d.find(".name").text(c.name),d.find(".js-icon").replaceWith(c.icon_html),a("h1.list-title .title").text(c.name)):(d=a('<li><a href="#/filter/'+(b||c.id)+'/">'+c.icon_html+'<span class="name">name placeholder</span></a></li>'),d.insertBefore(a.sidebar.sidebar.find('a[href="\\#/filter/add/"]').parents("li")),d.find(".name").text(c.name))},glyphHandler:function(b,c,d){d||(d="glyph");var e=
b.find(".js-"+d+"-templates"),f=b.find(this.getSelector(d,c));e.on("click","li > a",function(){e.find(".selected").removeClass("selected");var b=a(this);b.parents("li").addClass("selected");f.val(b.data(d));return!1})},confirmLeave:function(b,c,d){var e,f,g=a(window);g.on("beforeunload",e=function(){if(b())return c});g.on("wa_before_dispatched",f=function(a){b()?confirm(c+" "+d)||a.preventDefault():g.off("unload",e).off("wa_before_dispatched",f)})},cleanHash:function(a){"undefined"==typeof a&&(a=
window.location.hash.toString());for(a.length||(a=""+a);0<a.length&&"/"===a[a.length-1];)a=a.substr(0,a.length-1);a+="/";"#"!=a[0]?("/"!=a[0]&&(a="/"+a),a="#"+a):a[1]&&"/"!=a[1]&&(a="#/"+a.substr(1));if("#/"==a)return"";try{a=decodeURIComponent(a)}catch(c){}return a},isCtrlS:function(a){return 19==a.which||115==a.which&&a.ctrlKey||"s"==String.fromCharCode(a.which).toLowerCase()&&a.ctrlKey?!0:!1},getSelector:function(a,c){var d=':input[name="';return c?d+c+"\\["+a+'\\]"]':d+a+'"]'}}}})(jQuery);(function(a){a.sidebar={sidebar:null,options:{},init:function(b){this.options=b||{};this.sidebar=a("#wa-app").find(".sidebar:first");this.initCollapsibleSections();this.initCategoriesDragAndDrop();this.initFiltersDragAndDrop();this.highlight();a(window).trigger(a.Event("wa_sidebar_loaded"));this.reloader||(this.reloader=setInterval(function(){a.sidebar.reload()},3E5))},setHub:function(b){b=a("#hub-"+b).closest(".h-hub").removeClass("folded").find(".category-list:first");a("#wa-app > .sidebar .category-list").not(b).slideUp(200,
