...
return b});if(!d)return b;a.value=d.call("DOMParser"in window&&new DOMParser||window,a.value,"text/xml");return this.isXML(a.value)?a.value:b}}}})(jQuery);(function(a){a.ui=a.ui||{};var b=/left|center|right/,c=/top|center|bottom/,d={},e=a.fn.position,f=a.fn.offset;a.fn.position=function(f){if(!f||!f.of)return e.apply(this,arguments);var f=a.extend({},f),g=a(f.of),h=g[0],j=(f.collision||"flip").split(" "),i=f.offset?f.offset.split(" "):[0,0],k,q,m;return 9===h.nodeType?(k=g.width(),q=g.height(),m={top:0,left:0}):h.setTimeout?(k=g.width(),q=g.height(),m={top:g.scrollTop(),left:g.scrollLeft()}):h.preventDefault?(f.at="left top",k=q=0,m={top:f.of.pageY,
left:f.of.pageX}):(k=g.outerWidth(),q=g.outerHeight(),m=g.offset()),a.each(["my","at"],function(){var a=(f[this]||"").split(" ");1===a.length&&(a=b.test(a[0])?a.concat(["center"]):c.test(a[0])?["center"].concat(a):["center","center"]);a[0]=b.test(a[0])?a[0]:"center";a[1]=c.test(a[1])?a[1]:"center";f[this]=a}),1===j.length&&(j[1]=j[0]),i[0]=parseInt(i[0],10)||0,1===i.length&&(i[1]=i[0]),i[1]=parseInt(i[1],10)||0,"right"===f.at[0]?m.left+=k:"center"===f.at[0]&&(m.left+=k/2),"bottom"===f.at[1]?m.top+=
q:"center"===f.at[1]&&(m.top+=q/2),m.left+=i[0],m.top+=i[1],this.each(function(){var b=a(this),c=b.outerWidth(),e=b.outerHeight(),g=parseInt(a.curCSS(this,"marginLeft",!0))||0,h=parseInt(a.curCSS(this,"marginTop",!0))||0,o=c+g+(parseInt(a.curCSS(this,"marginRight",!0))||0),u=e+h+(parseInt(a.curCSS(this,"marginBottom",!0))||0),l=a.extend({},m),t;"right"===f.my[0]?l.left-=c:"center"===f.my[0]&&(l.left-=c/2);"bottom"===f.my[1]?l.top-=e:"center"===f.my[1]&&(l.top-=e/2);d.fractions||(l.left=Math.round(l.left),
l.top=Math.round(l.top));t={left:l.left-g,top:l.top-h};a.each(["left","top"],function(b,d){a.ui.position[j[b]]&&a.ui.position[j[b]][d](l,{targetWidth:k,targetHeight:q,elemWidth:c,elemHeight:e,collisionPosition:t,collisionWidth:o,collisionHeight:u,offset:i,my:f.my,at:f.at})});a.fn.bgiframe&&b.bgiframe();b.offset(a.extend(l,{using:f.using}))})};a.ui.position={fit:{left:function(b,c){var e=a(window),e=c.collisionPosition.left+c.collisionWidth-e.width()-e.scrollLeft();b.left=0<e?b.left-e:Math.max(b.left-
c.collisionPosition.left,b.left)},top:function(b,c){var e=a(window),e=c.collisionPosition.top+c.collisionHeight-e.height()-e.scrollTop();b.top=0<e?b.top-e:Math.max(b.top-c.collisionPosition.top,b.top)}},flip:{left:function(b,c){if("center"!==c.at[0]){var e=a(window),e=c.collisionPosition.left+c.collisionWidth-e.width()-e.scrollLeft(),d="left"===c.my[0]?-c.elemWidth:"right"===c.my[0]?c.elemWidth:0,f="left"===c.at[0]?c.targetWidth:-c.targetWidth,g=-2*c.offset[0];b.left+=0>c.collisionPosition.left?d+
f+g:0<e?d+f+g:0}},top:function(b,c){if("center"!==c.at[1]){var e=a(window),e=c.collisionPosition.top+c.collisionHeight-e.height()-e.scrollTop(),d="top"===c.my[1]?-c.elemHeight:"bottom"===c.my[1]?c.elemHeight:0,f="top"===c.at[1]?c.targetHeight:-c.targetHeight,g=-2*c.offset[1];b.top+=0>c.collisionPosition.top?d+f+g:0<e?d+f+g:0}}}};a.offset.setOffset||(a.offset.setOffset=function(b,c){/static/.test(a.curCSS(b,"position"))&&(b.style.position="relative");var e=a(b),d=e.offset(),f=parseInt(a.curCSS(b,"top",
!0),10)||0,g=parseInt(a.curCSS(b,"left",!0),10)||0,d={top:c.top-d.top+f,left:c.left-d.left+g};"using"in c?c.using.call(b,d):e.css(d)},a.fn.offset=function(b){var c=this[0];return!c||!c.ownerDocument?null:b?a.isFunction(b)?this.each(function(c){a(this).offset(b.call(this,c,a(this).offset()))}):this.each(function(){a.offset.setOffset(this,b)}):f.call(this)});a.curCSS||(a.curCSS=a.css);var g=document.getElementsByTagName("body")[0],h=document.createElement("div"),j,i;j=document.createElement(g?"div":
"body");i={visibility:"hidden",width:0,height:0,border:0,margin:0,background:"none"};g&&a.extend(i,{position:"absolute",left:"-1000px",top:"-1000px"});for(var k in i)j.style[k]=i[k];j.appendChild(h);i=g||document.documentElement;i.insertBefore(j,i.firstChild);h.style.cssText="position: absolute; left: 10.7432222px; top: 10.432325px; height: 30px; width: 201px;";h=a(h).offset(function(a,b){return b}).offset();j.innerHTML="";i.removeChild(j);g=h.top+h.left+(g?2E3:0);d.fractions=21<g&&22>g})(jQuery);(function(a){a.widget("ui.autocomplete",{options:{minLength:1,delay:300},_create:function(){var b=this,c=this.element[0].ownerDocument;this.element.addClass("ui-autocomplete-input").attr("autocomplete","off").attr({role:"textbox","aria-autocomplete":"list","aria-haspopup":"true"}).bind("keydown.autocomplete",function(c){var e=a.ui.keyCode;switch(c.keyCode){case e.PAGE_UP:b._move("previousPage",c);break;case e.PAGE_DOWN:b._move("nextPage",c);break;case e.UP:b._move("previous",c);c.preventDefault();
...
a,{item:this.active})}})})(jQuery);(function(a){a.iButton={version:"1.0.03",setDefaults:function(b){a.extend(d,b)}};a.fn.iButton=function(b){var e="string"==typeof arguments[0]&&arguments[0],d=e&&Array.prototype.slice.call(arguments,1)||arguments,f=0==this.length?null:a.data(this[0],"iButton");if(f&&e&&this.length){if("object"==e.toLowerCase())return f;if(f[e]){var k;this.each(function(b){var c=a.data(this,"iButton")[e].apply(f,d);if(0==b&&c)if(c.jquery)k=a([]).add(c);else return k=c,!1;else c&&c.jquery&&(k=k.add(c))});return k||this}return this}return this.each(function(){new c(this,
b)})};var b=0;a.browser.iphone=-1<navigator.userAgent.toLowerCase().indexOf("iphone");var c=function(c,h){var j=this,i=a(c),k=++b,n=!1,o,u,s,z=!1,v=null,q=null,m=null,B=null,h=a.extend({},d,h,a.metadata?i.metadata():{});s=h.labelOn==e&&h.labelOff==f;if(i.is(":checkbox, :radio")){if(a.data(i[0],"iButton"))return}else return i.find(":checkbox, :radio").iButton(h);a.data(i[0],"iButton",j);"auto"==h.resizeHandle&&(h.resizeHandle=!s);"auto"==h.resizeContainer&&(h.resizeContainer=!s);this.toggle=function(a){i.attr("checked",
arguments.length>0?a:!i[0].checked).trigger("change")};this.disable=function(b){var c=arguments.length>0?b:!n;n=c;i.attr("disabled",c);p[c?"addClass":"removeClass"](h.classDisabled);a.isFunction(h.disable)&&h.disable.apply(j,[n,i,h])};this.repaint=function(){t()};this.destroy=function(){a([i[0],p[0]]).unbind(".iButton");a(document).unbind(".iButton_"+k);p.after(i).remove();a.data(i[0],"iButton",null);a.isFunction(h.destroy)&&h.destroy.apply(j,[i,h])};i.wrap('<div class="'+a.trim(h.classContainer+
...
x=i.siblings("."+h.classLabelOn),y=x.children("span");if(h.resizeHandle||h.resizeContainer)o=y.outerWidth(),u=w.outerWidth();h.resizeHandle?(s=Math.min(o,u),r.css("width",s)):s=r.width();h.resizeContainer?(o=Math.max(o,u)+s+20,p.css("width",o),C.css("width",o-5)):o=p.width();var l=o-s-6,t=function(a){var b=i[0].checked?l:0;if((a=arguments.length>0?arguments[0]:true)&&h.enableFx){r.stop().animate({left:b},h.duration,h.easing);x.stop().animate({width:b+4},h.duration,h.easing);y.stop().animate({marginLeft:b-
l},h.duration,h.easing);w.stop().animate({marginRight:-b},h.duration,h.easing)}else{r.css("left",b);x.css("width",b+4);y.css("marginLeft",b-l);w.css("marginRight",-b)}};t(!1);var A=function(a){return a.pageX||(a.originalEvent.changedTouches?a.originalEvent.changedTouches[0].pageX:0)};p.bind("mousedown.iButton touchstart.iButton",function(b){if(!a(b.target).is(":checkbox, :radio")&&!(n||!h.allowRadioUncheck&&i.is(":radio:checked"))){b.preventDefault();v=r;q=A(b);m=q-(parseInt(r.css("left"),10)||0);
...
function(){p.removeClass(h.classFocus)});a.isFunction(h.click)&&i.bind("click.iButton",function(){h.click.apply(j,[i[0].checked,i,h])});i.is(":disabled")&&this.disable(!0);a.browser.msie&&(p.find("*").andSelf().attr("unselectable","on"),i.bind("click.iButton",function(){i.triggerHandler("change.iButton")}));a.isFunction(h.init)&&h.init.apply(j,[i,h])},d={duration:200,easing:"swing",labelOn:"ON",labelOff:"OFF",resizeHandle:"auto",resizeContainer:"auto",enableDrag:!0,enableFx:!0,allowRadioUncheck:!1,
clickOffset:120,className:"",classContainer:"ibutton-container",classDisabled:"ibutton-disabled",classFocus:"ibutton-focus",classLabelOn:"ibutton-label-on",classLabelOff:"ibutton-label-off",classHandle:"ibutton-handle",classHandleMiddle:"ibutton-handle-middle",classHandleRight:"ibutton-handle-right",classHandleActive:"ibutton-active-handle",classPaddingLeft:"ibutton-padding-left",classPaddingRight:"ibutton-padding-right",init:null,change:null,click:null,disable:null,destroy:null},e=d.labelOn,f=d.labelOff})(jQuery);jQuery.fn.farbtastic=function(a){$.farbtastic(this,a);return this};jQuery.farbtastic=function(a,b){a=$(a).get(0);return a.farbtastic||(a.farbtastic=new jQuery._farbtastic(a,b))};
jQuery._farbtastic=function(a,b){var c=this;$(a).html('<div class="farbtastic"><div class="color"></div><div class="wheel"></div><div class="overlay"></div><div class="h-marker marker"></div><div class="sl-marker marker"></div></div>');var d=$(".farbtastic",a);c.wheel=$(".wheel",a).get(0);c.radius=84;c.square=100;c.width=194;navigator.appVersion.match(/MSIE [0-6]\./)&&$("*",d).each(function(){if("none"!=this.currentStyle.backgroundImage){var a=this.currentStyle.backgroundImage,a=this.currentStyle.backgroundImage.substring(5,
a.length-2);$(this).css({backgroundImage:"none",filter:"progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true, sizingMethod=crop, src='"+a+"')"})}});c.linkTo=function(a){"object"==typeof c.callback&&$(c.callback).unbind("keyup",c.updateValue);c.color=null;if("function"==typeof a)c.callback=a;else if("object"==typeof a||"string"==typeof a)c.callback=$(a),c.callback.bind("keyup",c.updateValue),c.callback.get(0).value&&c.setColor(c.callback.get(0).value);return this};c.updateValue=function(){this.value&&
this.value!=c.color&&c.setColor(this.value)};c.setColor=function(a){var b=c.unpack(a);c.color!=a&&b&&(c.color=a,c.rgb=b,c.hsl=c.RGBToHSL(c.rgb),c.updateDisplay());return this};c.setHSL=function(a){c.hsl=a;c.rgb=c.HSLToRGB(a);c.color=c.pack(c.rgb);c.updateDisplay();return this};c.widgetCoords=function(a){var b,d,h=a.target||a.srcElement,j=c.wheel;if("undefined"!=typeof a.offsetX){for(var i={x:a.offsetX,y:a.offsetY},a=h;a;)a.mouseX=i.x,a.mouseY=i.y,i.x+=a.offsetLeft,i.y+=a.offsetTop,a=a.offsetParent;
a=j;for(i=j=0;a;){if("undefined"!=typeof a.mouseX){b=a.mouseX-j;d=a.mouseY-i;break}j+=a.offsetLeft;i+=a.offsetTop;a=a.offsetParent}for(a=h;a;)a.mouseX=void 0,a.mouseY=void 0,a=a.offsetParent}else i=c.absolutePosition(j),b=(a.pageX||0*(a.clientX+$("html").get(0).scrollLeft))-i.x,d=(a.pageY||0*(a.clientY+$("html").get(0).scrollTop))-i.y;return{x:b-c.width/2,y:d-c.width/2}};c.mousedown=function(a){document.dragging||($(document).bind("mousemove",c.mousemove).bind("mouseup",c.mouseup),document.dragging=
...
!1};c.updateDisplay=function(){var a=6.28*c.hsl[0];$(".h-marker",d).css({left:Math.round(Math.sin(a)*c.radius+c.width/2)+"px",top:Math.round(-Math.cos(a)*c.radius+c.width/2)+"px"});$(".sl-marker",d).css({left:Math.round(c.square*(0.5-c.hsl[1])+c.width/2)+"px",top:Math.round(c.square*(0.5-c.hsl[2])+c.width/2)+"px"});$(".color",d).css("backgroundColor",c.pack(c.HSLToRGB([c.hsl[0],1,0.5])));"object"==typeof c.callback?($(c.callback).css({backgroundColor:c.color,color:0.5<c.hsl[2]?"#000":"#fff"}),$(c.callback).each(function(){this.value&&
...
else{if(d.hash!==null){var a=location.hash.replace(/^[^#]*#\/*/,"").split("/")[0];if(d.hash.indexOf(a)===-1){clearTimeout(g);return}}if(d.loading)g=setTimeout(arguments.callee,350);else{h(f,e);if(h(f,e)<=d.distance){d.load();g=setTimeout(arguments.callee,350)}else{e.get(0).onscroll=c;clearTimeout(g)}}}},350),h="function"===typeof d.distanceBetweenBottoms?d.distanceBetweenBottoms:function(a,b,c){return a.position().top+a.outerHeight()-(c||0)-(b.scrollTop()+b.height())}}}})(jQuery);(function(a){a("#topic-access-toggle").iButton({labelOn:"",labelOff:"",className:"mini"});a.storage=new a.store;a.hub={options:{accountName:""},init:function(b){this.options=b||{};a.sidebar.init();"undefined"!=typeof a.History&&(a.History.bind(a.hub.dispatch),a.History.unbind=function(b,d){d?a.History.handlers.specific[b]&&a.each(a.History.handlers.specific[b],function(e,f){if(f===d)return a.History.handlers.specific[b].splice(e,1),!1}):(d=b,a.each(a.History.handlers.generic,function(b,c){if(c===
d)return a.History.handlers.generic.splice(b,1),!1}))});b=window.location.hash;("#/"===b||!b)&&this.dispatch()},forceHash:function(b){b=a.hub.helper.cleanHash(b);a.hub.currentHash!==b&&(a.hub.currentHash=b,a.wa.setHash(b))},backWithoutDispatch:function(b){var c;b&&a.History.bind(c=function(){a.History.unbind(c);b()});this.skipDispatch=1;history.back()},redispatch:function(){this.currentHash=null;this.dispatch()},skipDispatch:0,currentHash:null,dispatch:function(b){if(this!==a.hub)return a.hub.dispatch(b);
if(0<a.hub.skipDispatch)return a.hub.skipDispatch--,!1;b=a.hub.helper.cleanHash(b||void 0);if(a.hub.currentHash!=b){var c=a.hub.currentHash;a.hub.currentHash=b;var d=new a.Event("wa_before_dispatched");a(window).trigger(d);if(d.isDefaultPrevented())return a.hub.currentHash=c,a.wa.setHash(c),!1;if(b)if(b=b.replace(/^.*#\/?/,"").replace(/\/$/,""),b=b.split("/"),b[0]){for(var c="",d=b.length,e=0;e<b.length;e++){var f=b[e];if(2>e)if(0===e)c=f;else if("add"==f||parseInt(f,10)!=f&&-1==f.indexOf("=")&&"search"!=
c&&"following"!=c)c+=f.substr(0,1).toUpperCase()+f.substr(1);else{d=e;break}else{d=e;break}}b=b.slice(d);a.hub[c+"Action"]?(a.sidebar.highlight(),a.hub.currentAction=c,a.hub.currentActionAttr=b,a.hub[c+"Action"].apply(a.hub,b),a("body").animate({scrollTop:0},200)):console&&console.log("Invalid action name:",c+"Action")}else a.hub.defaultAction();else a.hub.defaultAction()}},defaultAction:function(b){a("#wa-app > .sidebar li.selected").removeClass("selected");a('#wa-app > .sidebar li a[href="#/"]').parent().addClass("selected");
b=this.getOrder("default",b);this.load("?module=topics"+(b?"&sort="+b:""),function(){})},getOrder:function(b,c){b="hub/"+b+"/order";return c?(a.storage.set(b,c),c):a.storage.get(b)},initLazyLoad:function(){var b=a(".lazyloading-paging");if(b.length){var c=parseInt(b.data("times")||"10",10),d=b.data("linkText")||"Load more",e=b.find("li.selected");if("1"==e.children("a").text()){b.hide();var f=a(window);f.lazyLoad("stop");e.next().length&&f.lazyLoad({container:"#h-content .h-topics",load:function(){f.lazyLoad("sleep");
var b=a(".lazyloading-paging").hide(),e=a(".h-footer"),j=b.find("li.selected").next().find("a").attr("href");if(j){var i=a("#h-content .h-topics");a(".loading-wrapper").show();a.get(j,function(j){j=a("<div></div>").html(j);i.append(j.find("#h-content .h-topics").children());var n=j.find(".lazyloading-paging").hide();b.replaceWith(n);b=n;e.replaceWith(j.find(".h-footer"));c-=1;b.find("li.selected").next().length?!isNaN(c)&&0>=c?(f.lazyLoad("sleep"),a(".lazyloading-load-more").length||a('<a href="#" class="lazyloading-load-more">'+
d+"</a>").insertAfter(b).click(function(){c=1;f.lazyLoad("wake");f.lazyLoad("force");return!1})):f.lazyLoad("wake"):(f.lazyLoad("stop"),a(".lazyloading-load-more").remove());j.remove();i.trigger("lazyload_append");a(".loading-wrapper").hide()})}else f.lazyLoad("stop")}})}}},popularAction:function(){this.defaultAction("popular")},archiveAction:function(){this.defaultAction("archive")},updatedAction:function(){this.defaultAction("updated")},recentAction:function(){this.defaultAction("recent")},unansweredAction:function(){this.defaultAction("unanswered")},
contactAction:function(b,c,d){(d=d||"")&&(d="&sort="+d);(c=c||"")&&(c="&hub_id="+c);this.load("?module=topics"+d+c+"&hash=contact/"+encodeURIComponent(b),function(){a(".h-header .h-sort").remove()})},load:function(b,c){var d=this.options,e=a.hub.load_protector=Math.random();a.get(b,{},function(b){if(e===a.hub.load_protector){a("#content").html(b);b=a("#content").find("h1:first");b.length&&(b=b.children().length?b.find(".title").length?b.find(".title").text():b.contents()[0].textContent?b.contents()[0].textContent:
b.contents()[0].innerText:b.text(),document.title=b+" \u2014 "+d.accountName);if(c)try{c.call(this)}catch(g){}a(window).trigger(a.Event("wa_loaded"))}})},typeAction:function(a,c){this.load("?module=topics&hash=type/"+a+(c?"&sort="+c:""),function(){})},hubAction:function(a,c){c=this.getOrder("hub"+a,c);this.load("?module=topics&hash=hub/"+a+(c?"&sort="+c:""))},followingAction:function(a){a=this.getOrder("following",a);this.load("?module=topics&hash=following"+(a?"&sort="+a:""),function(){})},categoryAddAction:function(a){var c=
this,a=parseInt(a);this.load("?module=settings&action=category&hub_id="+a,function(){c.streamSettingsHandler(null,null,"category")})},categoryAction:function(b,c,d){var e=this;this.load("?module=topics&hash=category/"+b+(c?"&sort="+c:""),function(){d&&"function"==typeof d&&d();a("a.stream-edit").click(function(){var c=a(this);c.find(".icon16").removeClass("settings").addClass("loading");a("#h-stream-settings").load("?module=settings&action=category&id="+b,function(){e.streamSettingsHandler(b,c,"category")});
return!1})})},filterAddAction:function(){var a=this;this.load("?module=settings&action=filter",function(){a.streamSettingsHandler(null,null,"filter")})},filterAction:function(b,c,d){var e=this,c=this.getOrder("filter"+b,c);this.load("?module=topics&hash=filter/"+b+(c?"&sort="+c:""),function(){d&&"function"==typeof d&&d();a("a.stream-edit").click(function(){var c=a(this);c.find(".icon16").removeClass("funnel").addClass("loading");a("#h-stream-settings").load("?module=settings&action=filter&id="+b,
...
waDesignLoad():a("#content").load("?module=design",function(){waDesignLoad(b)}):a("#content").load("?module=design",function(){waDesignLoad("")})},designThemesAction:function(){a("#wa-design-container").length?waDesignLoad():a("#content").load("?module=design",function(){waDesignLoad()})},streamSettingsSaveHandler:function(b,c,d,e,f,g){d.find(":submit").prop("disabled",!1);if("ok"==b.status){if(c.slideUp(),g&&(g.find(".icon16").removeClass("loading").addClass("category"==f?"settings":"funnel"),g.show()),
b.data){c=b.data||{};switch(f){case "category":a.hub.helper.updateCategory(e||c.id,c);break;case "filter":a.hub.helper.updateFilter(e||c.id,c)}if(e)switch(a(".h-saved").slideDown(),d=function(){a(".h-saved").show();setTimeout(function(){a(".h-saved").slideUp()},4E3)},f){case "category":0<c.type?a.hub.categoryAction(e,null,d):(a("#list-title-text").text(b.data.name),document.title=b.data.name+" \u2014 "+a.hub.options.accountName);break;case "filter":a.hub.filterAction(e,null,d)}else window.location.hash=
...
xhr:function(){var b=a.ajaxSettings.xhr();b.upload&&g.find(':input[type="file"]').length&&b.upload.addEventListener("progress",function(a){if(a.lengthComputable){var b=a.loaded||a.position,a=a.totalSize||a.total;j.show();j.css("width",Math.min(100,Math.floor(100*(b/a)))+"%")}},!1);return b},success:function(h){try{clearTimeout(i);g.find(".progressbar").hide();var j=a.parseJSON(h);f.streamSettingsSaveHandler(j,e,g,b,d,c||!1)}catch(o){a.hub.helper.formError(g,{submit:h.replace(/<\/?[^>]+>/gi,"").substr(0,
512)},"category")}},data:h,cache:!1,contentType:!1,processData:!1});return!1});a("a.cancel",e).click(function(){e.slideUp();c?(c.find(".icon16").removeClass("loading").addClass("category"==d?"settings":"funnel"),c.show()):window.location.hash="/";return!1});b&&a("a.js-delete",e).click(function(){var c=a(this);if("category"==d&&c.hasClass("js-dialog")){var e=a("#h-category-delete");e.waDialog({onSubmit:function(){f.streamDeleteHandler(b,d,e.find("form").serialize());return!1}})}else confirm($_("Are you sure?"))&&
...
return!1})},initBulkActions:function(){function b(b,c,d){if(b&&c&&b[0]&&c[0]&&!b.is(c[0])){var e=!1;c.parent().children().each(function(i,k){if(e){if(b.is(k)||c.is(k))return!1;a(k).find("input:checkbox.js-bulk-mode").prop("checked",d).change()}else if(b.is(k)||c.is(k))e=!0})}}var c=this;this.$bulk_menu=a("ul.js-bulk-menu:first");this.$sort_menu=a("ul.js-sort-menu:first");this.$bulk_menu.find("a:first").click(function(){a(this).is(":visible")&&c.$topics_ul.addClass("h-bulk-mode").closest(".h-stream").removeClass("h-mode-normal").addClass("h-mode-bulk");
c.$sort_menu.hide();c.$bulk_menu.find("li").toggle();c.bulkCount();return!1});this.$bulk_menu.find("a:last").click(function(){a(this).is(":visible")&&c.$topics_ul.removeClass("h-bulk-mode").closest(".h-stream").addClass("h-mode-normal").removeClass("h-mode-bulk");c.$sort_menu.show();c.$bulk_menu.find("li").toggle();return!1});this.$bulk_menu.find("a.js-bulk-action").click(function(){var b=a(this);if(c.bulkCount()){var d=b.data("confirm");if(!d||confirm(d))d=b.data("action"),d="bulk"+d.substr(0,1).toUpperCase()+
d.substr(1),c[d+"Action"].apply(c,[b])}else alert($_("Select at least one topic"));return!1});this.$topics_ul.on("change",":input.js-bulk-mode",function(){c.bulkCount();this.checked?a(this).closest("li").addClass("selected").find("h3").addClass("bold"):a(this).closest("li").removeClass("selected").find("h3").removeClass("bold")});var d=null,e=null;this.$topics_ul.on("click",":input.js-bulk-mode",function(f){var g=a(this),h=g.closest(".h-topic");g.prop("checked")?(f.shiftKey&&d&&b(d,h,!0),d=h,e=null):
(f.shiftKey&&e&&b(e,h,!1),d=null,e=h);c.bulkCount()});a.storage.get("sort-handler-unavailable-notice-hidden")?a(".sort-handler-unavailable-notice").remove():a(".sort-handler-unavailable-notice .h-close").click(function(){a(this).closest(".sort-handler-unavailable-notice").remove();a.storage.set("sort-handler-unavailable-notice-hidden",!0);return!1})},initFollowLinks:function(){this.$topics_ul.on("click",".h-follow",function(){var b=a(this),c=b.find("i"),d=c.hasClass("star-empty")?1:0;a.post("?module=following",
{topic_id:b.data("topic"),follow:d},function(e){if("ok"==e.status){var e=parseInt(a("#following-count").html()),f=b.closest("li"),g=f.find(".h-comments");d?(g.slideDown(),f.addClass("h-followed").removeClass("h-not-followed"),b.addClass("highlighted"),c.removeClass("star-empty").addClass("star"),b.find(".followers-count").html($_("Following")),e+=1):(g.slideUp(),f.removeClass("h-followed").addClass("h-not-followed"),b.removeClass("highlighted"),c.addClass("star-empty").removeClass("star"),b.find(".followers-count").html(""),
e-=1);a("#following-count").addClass("highlighted").html(e)}},"json");return!1})},initTopicTypesFilter:function(){function b(){var b={};e.map(function(){if(this.checked)return 1;b[this.value]=1}).length||(b={});var d=[],h=[];c.children().each(function(){var c=a(this).data("type-id");b[c]?d.push(this):h.push(this)});d.length?(a(d).css("opacity",0.7).slideUp(function(){a(d).css("opacity","");a(window).scroll()}),a(".h-footer .place-for-hidden-label").show().children("span").text(d.length),c.closest(".h-stream").addClass("h-js-filtered").removeClass("h-not-js-filtered")):
(a(".h-footer .place-for-hidden-label").hide().children("span").text("0"),c.closest(".h-stream").addClass("h-not-js-filtered").removeClass("h-js-filtered"));h.length&&a(h).slideDown(function(){a(window).scroll()})}var c=a("#h-content .h-topics"),d=a(".h-sort.js-sort-menu"),e=d.find(".h-filter-by-type :checkbox");d.find(".h-filter-by-type").on("change",":checkbox",function(){b();var c=e.map(function(){return(this.checked||null)&&a.trim(a(this).closest("label").text())}).get().join(", "),c=a.trim(d.find("ul li.selected a").text())+
(c?": "+c:"");d.find("> li > a i").text(c)});c.on("lazyload_append",function(){b()})},initManualDragAndDrop:function(b){this.$topics_ul.sortable({items:"> li",distance:5,tolerance:"pointer",handle:".sort,h3 a,i.h-glyph32",update:function(c,d){var e=d.item.data("id"),f=d.item.next("li").data("id");a.post("?module=topics&action=move",{id:e,before_id:f,category_id:b},null,"json").always(function(a,b){if("success"!=b||"ok"!==a.status)console&&console.log(b,a.errors||a)})}})},bulkCount:function(){var a=
this.$topics_ul.find(":input.js-bulk-mode:checked").length;this.$bulk_menu.find(".js-count").text(a);return a},bulkDeleteAction:function(b){b.find("i.icon16").removeClass("delete").addClass("loading");var c=[];this.$topics_ul.find(":input.js-bulk-mode:checked").each(function(){c.push(this.value)});var d=this;a.ajax({url:"?module=topics&action=delete",dataType:"json",type:"post",data:{ids:c},success:function(a){b.find("i.icon16").removeClass("loading").addClass("delete");d.$bulk_menu.find("a:last").click();
if("ok"!=a.status)default_error_handler(a);else if(a.data.deleted)for(var c in a.data.deleted)a.data.deleted.hasOwnProperty(c)&&d.$topics_ul.find('>li[data-id="'+a.data.deleted[c]+'"]').remove()}})},bulkMoveAction:function(b){var b="&hub_id="+b.data("hub")+"&category_id="+b.data("category"),c=a("#h-bulk-topics-move"),d=this;c.hasClass("dialog")?d.bulkMoveDialog(c):c.load("?module=dialog&action=topicsMove"+b,function(){c.addClass("dialog");c.find(':input[name="hub_id"]').change(function(){if(this.checked){c.find("select").attr("disabled",
!0);var b=a(this).parents(".value:first").find("select:first");b.length&&b.attr("disabled",null)}}).change();d.bulkMoveDialog(c)})},bulkMoveDialog:function(b){var c=this;b.waDialog({disableButtonsOnSubmit:!0,onLoad:function(){var a=[];c.$topics_ul.find(":input.js-bulk-mode:checked").each(function(){a.push(this.value)});b.find(':input[name="topic_ids"]').val(a.join(","))},onSubmit:function(){var c=b.find("form:first"),e=c.find(':input[name="hub_id"]:checked'),f=e.val(),g=e.parents(".value:first").find("select:first").val();
a.ajax({url:c.attr("action"),data:c.serialize(),dataType:"json",type:"post",success:function(){b.waDialog("close");window.location.hash=g?"/category/"+g+"/":f?"/hub/"+f+"/":"/"}});return!1}})}},helper:{formError:function(b,c,d){b.find(":submit").attr("disabled",null);if(c){for(var e in c||{})if(c.hasOwnProperty(e)){var f=b.find(this.getSelector(e,d));f.length||(f=b.find(this.getSelector(e)));f.length||(f=b.find(":submit:first"));f.addClass("error");var g=f.next(".errormsg");g.length?g.text(c[e]):
f.after(a('<em class="errormsg"></em>').text(c[e]))}b.find("input.error:first").focus()}else b.find(":input.error").removeClass("error"),b.find(".errormsg").text("")},updateCategory:function(b,c){var d=a.sidebar.sidebar.find("#category-"+b);d.length?(d.find(".count").text(c.topics_count),d.find(".name").text(c.name),d.find(".js-glyph").replaceWith(c.glyph_html),a("h1.list-title .title").text(c.name)):(d=a('<li class="drag-newposition"></li><li class="dr" id="category-'+c.id+'"><span class="count">'+
c.topics_count+'</span><a href="#/category/'+c.id+'/">'+c.glyph_html+'<span class="name">name placeholder</span><span class="count"><i class="icon10 add h-new-category" data-category-id="'+c.id+'"></i></span></a></li>'),a('div.h-hub[data-hub-id="'+c.hub_id+'"] .category-list > ul:first').prepend(d),d.find(".name").text(c.name))},updateFilter:function(b,c){var d=a.sidebar.sidebar.find('a[href="\\#/filter/'+b+'/"]').parents("li");d.length?(d.find(".count").text(c.topics_count),d.find(".name").text(c.name),
d.find(".js-icon").replaceWith(c.icon_html),a("h1.list-title .title").text(c.name)):(d=a('<li><a href="#/filter/'+(b||c.id)+'/">'+c.icon_html+'<span class="name">name placeholder</span></a></li>'),d.insertBefore(a.sidebar.sidebar.find('a[href="\\#/filter/add/"]').parents("li")),d.find(".name").text(c.name))},glyphHandler:function(b,c,d){d||(d="glyph");var e=b.find(".js-"+d+"-templates"),f=b.find(this.getSelector(d,c));e.on("click","li > a",function(){e.find(".selected").removeClass("selected");var b=
a(this);b.parents("li").addClass("selected");f.val(b.data(d));return!1})},confirmLeave:function(b,c,d){var e,f,g=a(window);g.on("beforeunload",e=function(){if(b())return c});g.on("wa_before_dispatched",f=function(a){b()?confirm(c+" "+d)||a.preventDefault():g.off("unload",e).off("wa_before_dispatched",f)})},cleanHash:function(a){"undefined"==typeof a&&(a=window.location.hash.toString());for(a.length||(a=""+a);0<a.length&&"/"===a[a.length-1];)a=a.substr(0,a.length-1);a+="/";"#"!=a[0]?("/"!=a[0]&&(a=
"/"+a),a="#"+a):a[1]&&"/"!=a[1]&&(a="#/"+a.substr(1));if("#/"==a)return"";try{a=decodeURIComponent(a)}catch(c){}return a},isCtrlS:function(a){return 19==a.which||115==a.which&&a.ctrlKey||"s"==String.fromCharCode(a.which).toLowerCase()&&a.ctrlKey?!0:!1},getSelector:function(a,c){var d=':input[name="';return c?d+c+"\\["+a+'\\]"]':d+a+'"]'}}}})(jQuery);(function(a){a.sidebar={sidebar:null,options:{},init:function(b){this.options=b||{};this.sidebar=a("#wa-app").find(".sidebar:first");this.initCollapsibleSections();this.initCategoriesDragAndDrop();this.initFiltersDragAndDrop();this.highlight();a(window).trigger(a.Event("wa_sidebar_loaded"));this.reloader||(this.reloader=setInterval(function(){a.sidebar.reload()},3E5))},setHub:function(b){b=a("#hub-"+b).closest(".h-hub").removeClass("folded").find(".category-list:first");a("#wa-app > .sidebar .category-list").not(b).slideUp(200,
function(){a(this).closest(".h-hub").addClass("folded")});b.slideDown(200)},initCategoriesDragAndDrop:function(){this.sidebar.find(".category-list ul").sortable({axis:"y",items:"> li",distance:5,update:function(b,c){var d={id:c.item.data("categoryId"),before_id:c.item.prev().data("categoryId")||0};a.post("?module=categories&action=move",d,null,"json").always(function(a,b){if("success"!=b||"ok"!==a.status)console&&console.log(b,a.errors||a)})}})},initFiltersDragAndDrop:function(){var b=a("#h-sidebar-filters-list"),
c={};b.children().each(function(b,d){var g=a(d);c[g.data("filterId")]=g});var d=a.storage.get("hub/filters_order");d&&d.reverse&&a.each(d.reverse(),function(a,d){c[d]&&c[d].prependTo(b)});b.sortable({axis:"y",items:"> li",distance:5,update:function(){var c=[];b.children().each(function(b,d){c.push(a(d).data("filterId"))});a.storage.set("hub/filters_order",c)}})},initCollapsibleSections:function(){var b=function(b,d){var e="hub/"+a(b).attr("id")+"/collapse",f=a(b).find(".collapse-handler"),g=a(b).next();
f.hasClass("darr")?(f.removeClass("darr").addClass("rarr"),g.hide(),d||a.storage.set(e,1)):(f.removeClass("rarr").addClass("darr"),g.show(),d||a.storage.del(e,1));return!1};this.sidebar.on("click",".collapse",function(){b(this)});this.sidebar.find(".collapse").each(function(){var c="hub/"+a(this).attr("id")+"/collapse";a.storage.get(c)&&b(this,!0)})},highlight:function(b){b=a.hub.helper.cleanHash(b);a("#wa-app > .sidebar li.selected").removeClass("selected");var c=a('#wa-app > .sidebar li a[href="'+
b+'"]');!c.length&&2<b.length&&(c=a('#wa-app > .sidebar li a[href="'+a.hub.helper.cleanHash(b.replace(/\/[^\/]+\/$/,""))+'"]'));c.length&&c.closest("li").addClass("selected")},reload:function(){a.post("?sidebar=1",function(b){a.sidebar.sidebar.html(b);a.sidebar.init()})}}})(jQuery);
